...
import { InputText } from 'primereact/inputtext'; import { Button } from 'primereact/button'; import { Divider } from 'primereact/divider';
                    ...
                    <div className="surface-card p-4 shadow-2 border-round w-full lg:w-6 ">
                        ...
                        <form>
                            ...
                            <div className="flex align-items-center justify-content-end mb-3">
                                <p className="font-medium no-underline ml-2 text-black-500 text-right cursor-pointer">Don't having account</p>
                                <Link to={'/register'} className="font-medium no-underline ml-2 text-blue-500 text-right cursor-pointer">Register today</Link>
                            </div>
